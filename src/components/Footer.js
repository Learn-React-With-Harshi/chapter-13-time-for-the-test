...
export const Footer = () => {
  ...
  return (
    <div data-testid="footer" className="flex mob:flex-col justify-around w-full shadow h-14 bg-yellow text-blue-dark text-center leading-[3.5rem] bottom-0 fixed z-40">
